page 50076 "POI Acc Check GL Cust"
{

    Caption = 'Ausnahmegenehmigung Debitor prüfen GL';
    PageType = Card;
    ApplicationArea = All;
        ...
        area(Content)
        {
            group(GL)
            {
                ...
                grid(KL_Grid)
                {
                    ...
                    label(GL_KL1)
                    {
                        caption = 'Authentizität Firma, Firmenanschrift und Einkäufer des Debitors sind bekannt und Verifikationsanruf sowie Prüfung Firmensitz und Fruchthandelsaktivität erübrigen sich';
                        ColumnSpan = 4;
                    }
            ...
            group(Handel)
            {
                Caption = 'Verkäufe werden genehmigt obwohl folgende Voraussetzungen nicht erfüllt sind:';
                // label(Handelsgen)
                // {
                ...
                grid(Stammblatt)
                {
                    ...
                    {
                        Caption = 'Kundenstammblatt ist noch nicht unterzeichnet zurück. (Etwaig vorgemerkte Rückvergütungen sind noch nicht bestätigt)';
                        StyleExpr = 'Attention';
                    }
            ...
            part("POI Acc Check Det Cust GL"; "POI Acc Check Det Cust GL")
            {
